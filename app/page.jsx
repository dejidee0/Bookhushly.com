...
import { Star, Search, Shield, Clock, Users, ArrowRight, Play, CheckCircle, Globe, Award, TrendingUp, MapPin, Calendar } from 'lucide-react'
  ...
  const features = [
    {
      ...
      description: "AI-powered search to find the perfect service provider for your specific needs across Africa."
    },
    {
      icon: <Shield className="h-8 w-8" />,
      title: "Verified Excellence",
      description: "Every vendor undergoes rigorous KYC verification ensuring premium quality and reliability."
    },
    {
    ...
    },
    {
      ...
      description: "Make informed decisions with authentic reviews from verified customers."
    }
  ]

  const stats = [
    { value: "2,500+", label: "Service Providers", icon: <Users className="h-6 w-6" /> },
    ...
    { value: "99.8%", label: "Success Rate", icon: <Award className="h-6 w-6" /> }
  ]
  ...
  const testimonials = [
    {
      ...
      company: "Lagos",
      content: "Bookhushly transformed how we book corporate events. The quality of vendors is exceptional!",
      rating: 5,
      avatar: "AJ"
    },
    {
      ...
      role: "Event Planner",
      company: "Abuja",
      content: "The platform's verification process gives me confidence. Every vendor delivers exactly as promised.",
      rating: 5,
      avatar: "FA"
    },
    {
      ...
      content: "As a vendor, Bookhushly has significantly increased our bookings and customer reach.",
      rating: 5,
      avatar: "CO"
    }
  ]
          ...
          <div className="w-full max-w-4xl mx-auto text-center">
            ...
            <div className="mb-12">
              ...
              <p className="text-xl lg:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed mb-12">
                Experience seamless hospitality services with verified providers across Nigeria and Africa.
              </p>
            </div>
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-8 shadow-2xl mb-12">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <Button size="lg" className="h-14 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-lg font-semibold">
                  Search
                </Button>
              </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
              {stats.map((stat, index) => (
                <div key={index} className="text-center backdrop-blur-sm bg-white/10 rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-colors">
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Join thousands of satisfied customers and verified service providers across the continent
            </p>
          </div>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {CATEGORIES.map((category, index) => (
              <Card key={category.value} className="group hover:shadow-2xl transition-all duration-300 border-0 shadow-lg hover:scale-105 bg-gradient-to-br from-white to-gray-50 overflow-hidden">
                ...
                <CardHeader className="text-center pb-4">
                  ...
                  <CardDescription className="text-muted-foreground">
                    Professional {category.label.toLowerCase()} services across Africa
                  </CardDescription>
                </CardHeader>
                <CardContent className="text-center">
                  <div className="mb-4">
                    ...
                    <span className="text-sm text-muted-foreground">4.8+ average rating</span>
                  </div>
                  <Button variant="outline" size="sm" className="group-hover:bg-blue-600 group-hover:text-white transition-colors w-full" asChild>
                    <Link href={`/services?category=${category.value}`}>
        ...
        <div className="container relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              We provide a secure, reliable platform that connects you with the finest service providers across the continent
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Real experiences from customers and vendors who trust Bookhushly for their service needs
            </p>
          </div>
        ...
        <div className="container text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Join thousands of satisfied customers and verified service providers on Africa's leading service platform
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-black font-semibold px-8 py-4 text-lg shadow-2xl hover:shadow-yellow-500/25 transition-all duration-300 transform hover:scale-105" asChild>
                <Link href="/register">
              ...
              <Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-blue-900 px-8 py-4 text-lg backdrop-blur-sm bg-white/10 transition-all duration-300" asChild>
                <Link href="/services">
